...
const SellerForm = () => {
  ...
  const handleSave = async () => {
    ...
    if (dataToSend.rentorsell === "Sell") {
      dataToSend.incomePolicy = "None";
      dataToSend.utilityPolicy = "None";
      dataToSend.petPolicy = "None";
    }
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/seller-form",
        formDataObj,
        {
          headers: {
              ...
              <div className="p-2 w-full md:w-[30%]">
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    disabled={formData.rentorsell === "Sell"}
                    className={`p-2 rounded-lg focus:outline-none pl-2 w-full ${
                      formData.rentorsell === "Sell" ? "cursor-not-allowed" : ""
                    }`}
                  >
